...
import type { MobileClassType } from '../../../Library/Library'
    ...
    return (
      <div className={'home' + mobileMode}>
        ...
        <div className="main">
          ...
          <div className="guide">
            <Features mobileMode={mobileMode} />
            <Browsers />
            <Other />
            <Note />
            <Usage />
...
const Features = ({ mobileMode }: { mobileMode: MobileClassType }) => {
  return (
    <>
      <div className={'feature' + mobileMode}>
        ...
        <div>
          ...
          <p>
            ...
            <br />
            ブラウザですべての処理を行うためRAMメモリによって受信できるサイズは変わるようです。 Chrome 64bit で 1GB
            を超えるとブラウザがクラッシュしやすくなるみたいです。(調査中)
          </p>
        </div>
      </div>
      <div className={'feature' + mobileMode}>
